    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent myIntent = new Intent(getApplicationContext(), MountainDetailsActivity.class);

                int mHeightTemp = mountainHeights[position];
                String mHeight = Integer.toString(mHeightTemp);
                String mName = mountainNames[position];
                String mLocation = mountainLocations[position];
                //myIntent.putExtra(mHeight, mName);
                myIntent.putExtra("Name"  , mName );
                myIntent.putExtra("Height" , mHeight);
